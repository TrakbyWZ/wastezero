...
1. Enter your **email address** in the first box. Your email address will be your `jdoe@wastezero.com` email address.
...
| **Data Logs**        | View uploaded log files and their data. You can open a file to see its contents and check for duplicates. |
...
- **What you see:** A list of batches, often with search and date filters.
- **What you can do:** Search or filter batches, create a new batch (choose customer and sequence options), and open a batch to see details.

### Customers

- **What you see:** A list of customers. You can search by name or number.
- **What you can do:** Search customers, add a new customer (number, description, email), and edit or deactivate existing customers.

### Customer Sequences

- **What you see:** A list of sequences linked to customers.
- **What you can do:** Filter by customer, add a new sequence (prefix, number format, range), and edit or delete sequences.

### Data Logs

- **What you see:** A list of uploaded log files (e.g. from camera systems).
- **What you can do:** Open a file to view its contents, see read counts and duplicate info, and (if available) upload a file manually.

---

## 5. Signing out and other options
